  ...
  return (
    <div className="relative rounded-lg overflow-hidden shadow-lg">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 text-white rounded-full z-10"
        onClick={prevSlide}
      >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 text-white rounded-full z-10"
        onClick={nextSlide}
      >
